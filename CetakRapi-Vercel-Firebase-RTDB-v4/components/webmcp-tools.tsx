...
export function WebMcpTools({ settings }: { settings: PublicSettings }) {
  useEffect(() => {
    ...
    void register({
      ...
      description: 'Lihat kertas yang tersedia, format file, batas ukuran per file, dan harga layanan CetakRapi.',
      ...
      execute: () => ({
        ...
        allowedFileTypes: settings.allowedTypes, maxFileMbPerFile: settings.maxFileMb, multipleFilesAllowed: true,
      }),
    });
    void register({
